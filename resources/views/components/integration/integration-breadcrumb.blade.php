<div x-data="{ pageName: `Integrations`}" class="mb-6 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
    ...
    <nav class="flex flex-col gap-6 sm:flex-row sm:items-center">
        ...
        <div x-data="{ addIntegrationModal: false }">
            <button @click="addIntegrationModal = !addIntegrationModal"
            ...
            <div x-show="addIntegrationModal" x-cloak class="modal fixed inset-0 z-99999 flex items-center justify-center overflow-y-auto p-5">
                <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
                <div @click.outside="addIntegrationModal = false"
                    class="relative w-full max-w-[558px] rounded-3xl bg-white p-6 lg:p-10 dark:bg-gray-900">
                    <!-- close btn -->
                    <button @click="addIntegrationModal = false"
                        ...
                        <form action="#">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" placeholder="Enter client ID here"
                                ...
                                <div>
                                    ...
                                    <input type="text" placeholder="Enter client secret here"
                                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                </div>
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            ...
                            <p class="mt-4 text-sm text-gray-500 dark:text-gray-400">
                                Paste the full URI, and we’ll automatically pull out and show
                                only the subdomain for quick reference.
                            </p>
                        </form>
                        <div class="mt-8 flex w-full items-center justify-between gap-3">
                            <button @click="addIntegrationModal = false" type="button"
