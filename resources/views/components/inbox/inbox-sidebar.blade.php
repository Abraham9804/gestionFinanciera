...
<div class="flex flex-col rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03] xl:w-1/5">
    ...
    <div class="no-scrollbar max-h-full overflow-auto py-6">
        <nav x-data="{ isActive: '{{ $activeItem }}' }" class="space-y-5">
            <!-- Mailbox Group -->
            <div>
                <h3 class="mb-3 text-xs font-medium uppercase leading-[18px] text-gray-700 dark:text-gray-400">
                    MAILBOX
                </h3>

                <ul class="flex flex-col gap-1">
                    @foreach ($mailboxItems as $item)
                        <li>
                            <a href="/"
                               @click="isActive = '{{ $item['key'] }}'"
                               ...
                               :class="isActive === '{{ $item['key'] }}' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'">
                                ...
                                @if (isset($item['count']))
                                    <span :class="isActive === '{{ $item['key'] }}' ? 'text-brand-500 dark:text-brand-400' : 'text-gray-700 dark:text-gray-300 group-hover:text-brand-500 dark:group-hover:text-brand-400'">
                                        {{ $item['count'] }}
                                    </span>
                                @endif
                            </a>
