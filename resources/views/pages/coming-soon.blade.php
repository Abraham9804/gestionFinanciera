        ...
        <div>
            ...
            <div class="absolute -translate-x-1/2 bottom-6 left-1/2">
                ...
                <div class="flex items-center justify-center gap-5">
                    <a href="#" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90">
                        <svg class="fill-current" width="20" height="21" viewBox="0 0 20 21" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
